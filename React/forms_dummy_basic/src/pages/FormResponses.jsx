...
const FormResponses = () => {
  ...
  const { forms, getFormResponses } = useForms();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2">
              <Button variant="outline" onClick={() => navigate(`/form/${formId}`)} className="hover:cursor-pointer">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-2xl font-bold text-gray-900">
                    {responses.length > 0 
                      ? formatDate(Math.max(...responses.map(r => new Date(r.submittedAt))))
                      : '-'
                    }
                  </p>
